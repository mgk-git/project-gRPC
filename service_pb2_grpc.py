...
class BankStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MsgDelivery = channel.unary_unary(
                '/Bank/MsgDelivery',
                request_serializer=service__pb2.RequestMsg.SerializeToString,
                response_deserializer=service__pb2.ReplyMsg.FromString,
                )
...
def add_BankServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MsgDelivery': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.RequestMsg.FromString,
                    response_serializer=service__pb2.ReplyMsg.SerializeToString,
            ),
    }
...
class Bank(object):
    ...
    def MsgDelivery(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Bank/MsgDelivery',
            service__pb2.RequestMsg.SerializeToString,
            service__pb2.ReplyMsg.FromString,
